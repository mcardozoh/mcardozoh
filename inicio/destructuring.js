/*Objet Destructuring: Destructuracion de objetos para no tener que acceder con el punto (.)
 a sus diferentes propiedades
 */
...
const Persona2 = {
  ...
  console.log(
    `El señor ${primerNombre + " " + primerApellido} vive en ${
      residencia.ciudad + ", " + residencia.departamento + " - " + residencia.pais
    }`
  );
